...
const HeroContent: React.FC<HeroContentProps> = ({
  ...
  return (
    <div className="flex overflow-hidden text-white flex-col self-stretch my-auto min-w-[240px] w-[599px] max-md:max-w-full">
      <div className="text-base">{date}</div>
      <h1 className="mt-9 text-6xl text-white tracking-wide leading-none max-md:max-w-full max-md:text-4xl">
        {title}
      </h1>
      ...
      <div className="flex gap-2.5 items-start self-start mt-9 text-2xl leading-none text-center">
        <button
          className="overflow-hidden  text-white px-10 py-4 bg-green-500 rounded-md max-md:px-5"
          aria-label={ctaText}
        >
          {ctaText}
        </button>
