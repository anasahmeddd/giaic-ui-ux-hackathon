...
export const metadata: Metadata = {
    title: "Giaic UI/IX Hackathon | Shop",
    description: "Giaic UI/IX Hackathon made by Anas Ahmed | Shop Page",
};
...
const page = () => {
    ...
    return (
        <main>
            <div className="flex px-4 sm:px-32 overflow-hidden flex-col justify-center items-baseline py-6 w-full font-bold text-center whitespace-nowrap bg-neutral-50 max-md:max-w-full">
                <div className="flex overflow-hidden flex-wrap gap-3 my-auto  justify-between items-center w-full">
                    <h1 className="text-2xl tracking-normal leading-none text-slate-800  max-md:max-w-full">
                        Shop
                    </h1>
                    <div className="flex overflow-hidden flex-col items-end self-stretch my-auto text-sm tracking-wide leading-6 min-w-[240px] w-[509px] max-md:max-w-full">
                        <nav className='flex gap-1 w-fsull px-5 md:px-36 text-gray-500 font-semibold  items-center'>
                            <Link href={'/'}>Home
                            </Link>
                            <BiChevronRight />
                            <span><Link className='text-black' href={'/shop'}>Shop</Link></span>
                        </nav>
                    </div>
                </div>
            </div>
